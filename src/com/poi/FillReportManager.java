...
public class FillReportManager {
	public static void fillReport(HSSFSheet worksheet, int startRowIndex,  
            int startColIndex, List<Report> datasource) {  
        ...
        for (int i=startRowIndex; i+startRowIndex-2< datasource.size()+2; i++) {  
            ...
            cell2.setCellValue(datasource.get(i-2).getTaxId());  
            cell2.setCellStyle(bodyCellStyle);  
  
 
            HSSFCell cell3 = row.createCell(startColIndex+2);  
            cell3.setCellValue(datasource.get(i-2).getImposeType());  
            cell3.setCellStyle(bodyCellStyle);  
  

            HSSFCell cell4 = row.createCell(startColIndex+3);  
            cell4.setCellValue(datasource.get(i-2).getYear()); 
            cell4.setCellStyle(bodyCellStyle);  
  
 
            HSSFCell cell5 = row.createCell(startColIndex+4);  
            cell5.setCellValue(datasource.get(i-2).getMonth());  
